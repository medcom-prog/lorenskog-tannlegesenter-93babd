...
// Warm modern dental clinic interior — NOT a doctor portrait, NOT a stethoscope
const HERO_IMAGE =
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          fetchPriority="high"
        />
        {/* Warm gradient — cream paper feel */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'linear-gradient(to top, #FAF6F0 20%, rgba(250,246,240,0.75) 55%, rgba(250,246,240,0.18) 100%), linear-gradient(to right, rgba(250,246,240,0.85) 0%, rgba(250,246,240,0.45) 55%, transparent 100%)',
          }}
        />
      </div>
