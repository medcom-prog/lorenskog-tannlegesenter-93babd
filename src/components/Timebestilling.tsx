        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              <a
                href="tel:+4767904090"
                className="flex items-center gap-4 p-4 rounded-2xl bg-[#FAF6F0]/10 hover:bg-[#FAF6F0]/20 transition-colors group"
              >
                <div className="w-10 h-10 rounded-xl bg-[#D4A373] flex items-center justify-center shrink-0">
          ...
          >
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-[#5A4B3C] mb-1.5">
                    Fornavn
                  </label>
                  <input
                    type="text"
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 rounded-xl border border-[#E0C9B0] bg-white text-[#1A1008] text-sm focus:outline-none focus:ring-2 focus:ring-[#8B5A3C]/40 focus:border-[#8B5A3C] transition-colors">
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-xl bg-[#8B5A3C] text-[#FAF6F0] font-semibold text-sm hover:bg-[#6B3A1C] transition-colors"
              >
                Send forespørsel
              </button>
              <p className="text-xs text-center text-[#7A6555]">
                Eller ring oss direkte: <a href="tel:+4767904090" className="text-[#8B5A3C] hover:underline">67 90 40 90</a>
              </p>
            </form>
          </motion.div>
        </div>
