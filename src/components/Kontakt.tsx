      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#3D2C1E]">
              <p>
              ...
              <p>
                <a href="mailto:kontakt@lorenskogtannlege.no" className="hover:text-[#8B5A3C] transition-colors break-all">
          ...
          >
            ...
            <div className="text-sm text-[#3D2C1E] space-y-1">
              <p>Skårersletta 10</p>
              <p>1473 Lørenskog</p>
              <p className="text-xs text-[#8B5A3C] mt-2 font-medium">Vis-a-vis Metro-senteret. Fri parkering.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-sm text-[#3D2C1E] space-y-1">
              ...
              <p className="text-xs text-[#8B5A3C] mt-2 font-medium">Ring for neste ledige time.</p>
            </div>
          </motion.div>
        </div>
      </div>
